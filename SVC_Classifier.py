...
model_path = "../../Downloads/trained_model_svm.pkl"
...
def train_and_evaluate_model(cve_data):
    ...
    # Crear un pipeline que convierta el texto en TF-IDF y un modelo de clasificación SVM optimizado con gradiente descendente estocástico (SGD) con SMOTE para clases con pocos datos
    pipeline = Pipeline([

...
model_path = "./trained_model_nb.pkl"
...
def train_and_evaluate_model(cve_data):
    ...
    # Obtener las etiquetas únicas en el conjunto de datos de prueba
    unique_labels = y_test.unique()

    # Crear un pipeline que convierta el texto en TF-IDF y luego aplique Naive Bayes con SMOTE para clases con pocos datos
    pipeline = Pipeline([
